...
#  Updated: 2026/03/31 09:51:20 by cehenrot        ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
def main() -> None:
    ...
    try:
        lightning = SpellCard('Lightning Bol', 3, Rarity.COMMON, 'Spell',
                              'Deal 3 damage to target')
        crystal = ArtifactCard('Mana Crystal', 2, Rarity.RARE, 'Artifact', 5,
